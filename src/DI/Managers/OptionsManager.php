...
class OptionsManager implements ArrayAccess
{
     ...
     * avoiding unnecessary resolutions. Disabling lazy loading changes how
     * future class bindings are stored; it does not eagerly resolve definitions
     ...
     *
     * The preload file contains absolute paths for classes discoverable from
     * current registration metadata. It does not traverse the entire autowired
     * dependency graph and must be regenerated when deployment paths change.
     *
